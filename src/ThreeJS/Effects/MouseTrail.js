...
export default class MouseTrail {
    constructor(bounds) {
        ...
        this.params = {
            fadeTime: 0.8, // seconds for amplitude to fall to ~37 %
            trailSpacing: 1.5, // minimum world-unit distance between trail points
        };
    ...
    bindPointerEvents() {
        this.onPointerMove = (e) => {
            ...
            // Fast mouse → large distDelta → small strength → faint wave
            const strength = 1.0 / (1.0 + distDelta * 4.0);
            this.trail.push({ x, z, age: 0, distDelta: strength });
            this.lastPoint = { x, z };
